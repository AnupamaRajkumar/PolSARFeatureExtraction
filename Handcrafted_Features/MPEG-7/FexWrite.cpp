                                ...
                                int bin1, int bin2, int bin3 )
{
	...
	std::cout << "number of dominant colors:"<< ndc << std::endl ;
	...
	for( int i = 0; i < ndc; i++ )
	{
			std::cout << "Precentage: " << std::setprecision(4) << domcol[i].m_Percentage
				<< ",color " << domcol[i].m_ColorValue[0]
				<< ",color " << domcol[i].m_ColorValue[1]
				<< ",color " << domcol[i].m_ColorValue[2] << std::endl;
